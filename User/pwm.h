...
extern u16 adjust_duty; // 要调整到的占空比(对应的值)
extern u16 cur_duty;    // 当前设置的占空比(对应的值)
...
extern void refresh_pin14_pwm_duty(void); // 更新14脚的PWM占空比
// 更新15脚的PWM占空比（未验证）
extern void refresh_pin15_pwm_duty(void);
